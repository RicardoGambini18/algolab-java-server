...
@SolidPrinciple(name = "Principio Abierto/Cerrado (OCP) + Principio de Segregación de Interfaces (ISP)", solvedProblem = "OCP: Permite agregar nuevas tareas de setup sin tocar el código del orquestador. ISP: Mantiene un contrato limpio (execute) para que las tareas no implementen métodos innecesarios.")
