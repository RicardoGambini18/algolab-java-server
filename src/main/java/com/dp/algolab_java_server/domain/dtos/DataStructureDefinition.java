...
public class DataStructureDefinition<T extends BaseAlgorithmDefinition> {
  ...
  @Schema(description = "Lista de algoritmos soportados")
  @JsonProperty("algorithms")
  @Builder.Default
  private List<T> algorithms = new ArrayList<>();
}
